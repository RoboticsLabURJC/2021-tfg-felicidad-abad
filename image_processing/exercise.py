...
class Template:
    ...
    def parse_code(self, source_code):
        ...
        if(source_code[:5] == "#save"):
            ...
            ''' try:
                ...
                print("el resto del source code")
                print(source_code[12:])
                source_code = source_code[12:]
                print("vamos por el try")
            except:
                print("vamos por el except")
                debug_level = 1
                source_code = ""
            ...
            print("hemos ido por el segundo else:")
            print(self.seperate_seq_iter(source_code))
    ...
    def seperate_seq_iter(self, source_code):
        ...
        print("la variable infinite loop vale:")
        print(infinite_loop)
        ...
        try:
            ...
            print("en la funcion que separa, el codigo iterativo es:")
            print(iterative_code)
            print("en la funcion que separa, el codigo secuencial es:")
    ...
    def execute_thread(self, source_code):
        ...
        logging.debug(self.send_code_message())
...
if __name__ == "__main__":
    sys.path.append("/RoboticsAcademy/exercises/image_processing/web-template")
    logging.basicConfig(filename="exercisepy.log", level=logging.DEBUG)
    logging.warning("se ejecuta el exercise.py")
    server = Template()
    server.run_server()
